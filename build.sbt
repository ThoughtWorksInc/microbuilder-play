...
libraryDependencies += "com.thoughtworks.microbuilder" %% "microbuilder-core" % "0.1.1" % TestHaxeJava classifier "haxe-java"

libraryDependencies += "com.thoughtworks.microbuilder" %% "microbuilder-core" % "0.1.1"
